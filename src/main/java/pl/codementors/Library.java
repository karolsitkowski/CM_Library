...
public class Library implements Serializable {
    ...
    public List<BookStand> getBookStands() {
        return bookStands;
    }
    ...
    public void addBookStand(BookStand bookStand, int index) {
        this.bookStands.add(index, bookStand);
    }
...
//    }
    ...
    public static void addBook(Library library) {
        ...
        for (int i = library.getBookStands().size(); i <= indexOfBookStand; i++) {
            library.getBookStands().add(null);
        }
        if (library.getBookStand(indexOfBookStand) == null) {
            library.addBookStand(new BookStand(), indexOfBookStand);
        }

        for (int i = library.getBookStand(indexOfBookStand).getShelves().size(); i <= indexOfShelf; i++) {
            library.getBookStand(indexOfBookStand).getShelves().add(null);
        }
        ...
        for (int i = library.getBookStand(indexOfBookStand).getShelf(indexOfShelf).getBooks().size(); i <= indexOfBook; i++) {
            library.getBookStand(indexOfBookStand).getShelf(indexOfShelf).getBooks().add(null);
        }
    ...
    public static void print(Library library) {
        ...
        for (int i = 0; i < library.bookStands.size(); i++) {
